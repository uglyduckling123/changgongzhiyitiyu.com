<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/www/wwwroot/changgongzhiyitiyu.com/public/../application/admin/view/dashboard/index.html";i:1679205778;s:78:"/www/wwwroot/changgongzhiyitiyu.com/application/admin/view/layout/default.html";i:1642752126;s:75:"/www/wwwroot/changgongzhiyitiyu.com/application/admin/view/common/meta.html";i:1642752126;s:77:"/www/wwwroot/changgongzhiyitiyu.com/application/admin/view/common/script.html";i:1642752126;}*/ ?>
<!DOCTYPE html>
                            ...
                            <div class="card-block">
                                <div class="row row-sm stats-container">
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"> <?php echo $todaymakeuser; ?></div>
                                            <div class="name"> <?php echo __('今日预约人数'); ?></div>
                                        </div>
                                        <div class="progress">
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            ...
                                            <div class="name"> <?php echo __('三日预约人数'); ?></div>
                                        </div>
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success" style="width: 20%"></div>
                                        </div>
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            ...
                                            <div class="name"> <?php echo __('七日预约人数'); ?></div>
                                        </div>
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success" style="width: 20%"></div>
                                        </div>
